                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                <h1 className="font-bold text-xl text-foreground truncate">{displayName}</h1>
                                {/* Dynamic Labels */}
                                {companySize && <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded border border-border text-muted-foreground bg-muted tracking-wider">{companySize}</span>}
                                {industry && <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded border border-border text-muted-foreground bg-muted tracking-wider max-w-[150px] truncate">{industry}</span>}
                            </div>
                            <div className="text-xs text-muted-foreground font-mono">{domain}</div>
                        </div>
                    </div>

                    {/* Actions Area */}
                    <div className="flex items-center gap-3">
                        <button className="text-xs px-3 py-1.5 rounded-full border border-border text-muted-foreground hover:bg-muted font-mono uppercase tracking-wider flex items-center gap-2 transition-colors">
